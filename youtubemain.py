...
WIDTH, HEIGHT = 630, 900

SCREEN = pygame.display.set_mode((WIDTH, HEIGHT))
BACKGROUND = pygame.image.load("Wordle-PyGame-main/assets/Starting Tiles.png")
BACKGROUND_RECT = BACKGROUND.get_rect(center=(317, 300))
ICON = pygame.image.load("Wordle-Pygame-main/assets/Icon.png")
...
GUESSED_LETTER_FONT = pygame.font.Font("Wordle-Pygame-main/assets/FreeSansBold.otf", 50)
AVAILABLE_LETTER_FONT = pygame.font.Font("Wordle-Pygame-main/assets/FreeSansBold.otf", 25)
...
# This list stores guesses and it allows the user to only have 6 tries to get the correct word
guesses = [[]] * 6
...
class Letter:
    ...
    def draw(self):
        # Puts the letters in the spots chosen by the user.
    ...
    def delete(self):
        # Fills empty spot with a white background
...
class Indicator:
    ...
    def draw(self):
        # Puts the indicator at the spots chosen by the user
...
def play_again():
    ...
    play_again_font = pygame.font.Font("Wordle-PyGame-main/assets/FreeSansBold.otf", 40)
